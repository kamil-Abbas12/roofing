...
<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 xl:gap-10 my-12 items-stretch'>
      ...
      {[
        {
          icon: <Search className="text-blue-800 h-8 w-8" />,
        ...
        {
          icon: <PiArrowElbowLeftUp className="text-blue-800 h-8 w-8" />,
        ...
        {
          icon: <GrMapLocation className="text-blue-800 h-8 w-8" />,
        ...
        {
          icon: <Globe className="text-blue-800 h-8 w-8" />,
        ...
        {
          icon: <PenSquare className="text-blue-800 h-8 w-8" />,
        ...
        {
          icon: <MessageCircleCheck className="text-blue-800 h-8 w-8" />,
...
<div
   key={i}
 className='bg-white border-2 border-gray-300 hover:border-blue-300 rounded-xl flex w-full h-full
          ...
          <div className='flex flex-col p-6  lg:p-10 w-full'>
            ...
            <div className="flex items-center justify-center h-14 w-14 bg-blue-200 rounded-md shadow-lg hover:bg-blue-400 transition-colors">
              {card.icon}
            </div>
    ...
    {/* <div className="flex justify-center mt-12 px-4">
      <div className="w-full max-w-5xl bg-orange-100 rounded-2xl p-8">
        <h1 className="text-lg md:text-xl lg:text-3xl font-bold text-blue-900">
