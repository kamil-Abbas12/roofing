  ...
  return (
    <section className="w-full bg-[#061a62] pt-20">
      <div className="relative overflow-hidden">
        ...
        {/* ======= FULL GEOMETRIC BACKGROUND RESTORED ======= */}
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-br from-[#061b6b] via-[#051655] to-[#031449]" />

          <div
            className="absolute inset-0 bg-[#0e3aa1]/35"
            style={{ clipPath: "polygon(0 0, 62% 0, 40% 55%, 0 70%)" }}
          />
          <div
            className="absolute inset-0 bg-[#1b57c7]/25"
            style={{ clipPath: "polygon(0 30%, 42% 10%, 62% 55%, 0 92%)" }}
          />
          <div
            className="absolute inset-0 bg-[#0a2b86]/45"
            style={{ clipPath: "polygon(20% 0, 70% 0, 55% 38%, 28% 30%)" }}
          />
          <div
            className="absolute inset-0 bg-[#0b2f93]/35"
            style={{ clipPath: "polygon(0 68%, 44% 46%, 66% 100%, 0 100%)" }}
          />
        ...
        <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 py-12 md:grid-cols-2 xl:gap-20">
          ...
          >
            ...
            >
              <a
                href={ctaHref}
                className="inline-flex h-11 w-fit items-center justify-center rounded-xl bg-[#3f72d7] px-6 text-sm font-semibold text-white shadow-sm transition hover:bg-[#3566c9]"
              >
                {ctaText}
              </a>
  ...
  {["/pic1.jpg", "/pic2.jpg", "/pic3.jpg"].map((src, i) => (
    ...
    >
      ...
      />
            ...
            <motion.p
              variants={fadeUp}
              className="mt-10 max-w-xl whitespace-pre-line text-sm leading-relaxed text-white/75"
            >
              {description}
            </motion.p>
          </motion.div>
          ...
          <div className="relative">
            <div className="relative overflow-hidden rounded-3xl bg-white/10 shadow-2xl ring-1 ring-white/10">
