...
<section className='bg-gray-900 py-6 md:py-10 lg:py-16 xl:py-20'>
  <div className="container mx-auto px-4 sm:px-6 lg:px-10 text-center">
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 xl:gap-10 my-8 lg:my-14 xl:my-20'>
      ...
      <div className='bg-gray-800 border border-gray-50 rounded-md w-full max-w-sm mx-auto'>
        <div className='flex flex-col justify-center items-center py-8 px-4'>
          <div className="flex items-center justify-center h-15 w-15 bg-blue-500 rounded-full 
          shadow-lg cursor-pointer hover:bg-blue-700 transition-colors">
            <FaEye className="text-white h-8 w-8" />
          </div>
          <h2 className='text-lg  xl:text-xl text-white mt-6'>Weak Digital Presence</h2>
      ...
      <div className='bg-gray-800 border border-gray-50 rounded-md w-full max-w-sm mx-auto'>
        <div className='flex flex-col justify-center items-center py-8 px-4'>
          ...
          <h2 className='text-lg xl:text-xl text-white mt-6'>Unpredictable Income Cycles</h2>
          <p className='text-sm md:text-lg text-gray-300 mt-6'>
      ...
      <div className='bg-gray-800 border border-gray-50 rounded-md w-full max-w-sm mx-auto'>
        <div className='flex flex-col justify-center items-center py-8 px-4'>
          ...
          <h2 className='text-lg  xl:text-xl text-white mt-6'>Lost Insurance Claim Leads</h2>
          <p className='text-sm md:text-lg text-gray-300 mt-6'>
      ...
      <div className='bg-gray-800 border border-gray-50 rounded-md w-full max-w-sm mx-auto'>
        <div className='flex flex-col justify-center items-center py-8 px-4'>
          <div className="flex items-center justify-center h-15 w-15 bg-blue-500 rounded-full shadow-lg cursor-pointer
           hover:bg-blue-700 transition-colors">
            <ChartAreaIcon className="text-white h-8 w-8" />
          </div>
          <h2 className='text-lg xl:text-xl text-white mt-6'>No Clear Performance Insights</h2>
          <p className='text-sm md:text-lg text-gray-300 mt-6'>
    ...
    <h2 className='text-lg md:text-xl xl:text-2xl text-white mt-6'>
